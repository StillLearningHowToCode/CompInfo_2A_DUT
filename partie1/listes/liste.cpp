...
// notion de "template"
/* En programmation informatique, les templates sont une particularité de la programmation en langage C++,
 * qui autorise l'écriture d'un code sans considération envers le type des données avec lesquelles il sera finalement utilisé.
 * Les templates introduisent le concept de programmation générique dans le langage. */
